...
<!--  <div class="loader"> </div> -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
            	 ...
            	 <div class="data_search" style=" width:80%; margin:auto;">
	               	
	             	<div style="display:inline; margin-left:100px;">
	                	<button type="button" id="p_btn" class="btn btn-info btn-sm" style="margin-left:10px; width:150px;"">포토폴리오 등록</button>
	               	</div>
                </div>
                <!-- /.row -->
				...
				<div class="row" style="text-align:center; margin:auto;">
                    ...
                    <div class="col-lg-12">
                      <!--    <h2>시세관리</h2>-->
                        ...
                        <div class="table-responsive" style=" width:1000px; height:1000px; text-align:center; margin:auto;">
                            <table class="table table-hover" style="text-align:center; margin:auto;">
                                <thead>
                                    <tr>
                                    	<th class="t_num">번호</th>
                                    	<th class="t_name">프로젝트 종류</th>
                                        <th class="t_img">사진</th>
										<th class="t_contents">프로젝트 내용</th>
										<th class="t_reg">등록날짜</th>
										<th class="t_btn">수정</th>
                                    </tr>
                                </thead>
                                <tbody style="height:900px;" overflow-y="auto" id="board_data">
                                
                                	<tr>
                                		<td class="t_num"></td>
                                		<td class="t_project_type"></td>
                                		<td class="t_img"><img src="../img/1.jpg"></img></td>
                                		<td class="t_contents"></td>
                                		<td class="t_reg"></td>
                                		<td class="t_btn"><button>삭제</button>
                              			<button>수정</button></td>
                                	</tr>
                                </tbody>
                            </table>
							<div class="board_page" id = "under_board" style="margin-top:10px;">
								<button type="button" id="b_previous" onClick="b_previousPage()">&#60;</button>
								<ul id = "under_count">
								
								</ul>
								<button type="button" id="b_next" style="margin-left:20px;" onClick="b_nextPage()">&#62;</button>
							</div>
                        </div>
                    </div>
    ...
    <!-- /#wrapper -->
	 <!--<div id="dialog" style="text-align:center;">
	   <button type="button" style="width:70px; height:30px;">확인</button>
	   <button type="button" style="width:70px; height:30px;">취소</button> 
	</div>-->
    <!-- jQuery -->
	...
	<script src="../js/d_dialog.js"></script>
	<script src="../js/admin/portfolio_manage.js"></script>
	<script src="../js/admin/portfolio_board.js"></script>

	
	<script>
		document.getElementById("p_btn").onclick = function(){
			location.href="upload_portfolio.jsp"
		}
		//d.show();
	</script>
