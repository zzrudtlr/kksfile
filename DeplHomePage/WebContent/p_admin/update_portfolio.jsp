...
<!--  <div class="loader"> </div> -->
                    ...
                    <div class="col-lg-12">
                      <!--    <h2>시세관리</h2>-->
                        ...
                        <div class="table-responsive" style="width:80%; height:800px;">
                           <form name="serverInfoForm" id="serverInfoForm" method="post" action="../process/portfolio/send_image_data.jsp" enctype = "multipart/form-data" style="width:500px;  text-align:left;">
								<table style="float:left;">
									<tbody style="width:500px;">
										<tr>
											<td style="width:150px;"><p>파일</p></td>
											<td><input type="file"  onchange="openFile(event)" name="agentInstallFile" id="agentInstallFile" style="width:400px;"/></td>
										</tr>
										<tr>
											<td style="width:150px;"><p>프로젝트 종류</p></td>
											<td><select style="width:150px;" name="p_type" id="p_type" style="height:50px;"></select></td>
										</tr>
										<tr style="text-align:top;">
											<td style="width:150px;"><p>프로젝트 설명</p></td>
											<td><textarea id="contents" rows="5" cols="40"></textarea></td>
										</tr>
										<tr>
	...
	<script src="../js/admin/upload_portfolio.js"></script>
	<script>
	var id = <%= request.getParameter("id") %>;
	var xhr = new XMLHttpRequest();
	  xhr.open("POST", "../process/portfolio/get_d_portfo_data.jsp", true);
	  ...
	  xhr.onreadystatechange = function() {//Call a function when the state changes.
	      if(xhr.readyState == XMLHttpRequest.DONE && xhr.status == 200) {
	    	 ...
	    	 console.log(obj_data[0].img);
	    	 document.getElementById("agentInstallFile").value = obj_data[0].img;
	    	 document.getElementById("p_type").options[obj_data[0].p_type] = true;
	    	 document.getElementById("contents").innerHTML = obj_data[0].contents;
	    	 document.getElementById("show_img").src = obj_data[0].img;
