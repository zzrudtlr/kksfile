...
(function(){
	...
	function init(){
		var xhr = new XMLHttpRequest();
		  xhr.open("POST", "../process/portfolio/get_total_portfolio_count.jsp", true);
		      ...
		      if(xhr.readyState == XMLHttpRequest.DONE && xhr.status == 200) {
		    	 ...
		    	 if(obj.result == "1"){
			    	 boardSetting({
		    				...
		    				"board_data_url" : "../process/portfolio/get_board_portfolio.jsp",// 게시판 글 가져올 url
		    				"current_page_doing" : function(data){
		    				//	alert("current_page_doing : " + page);
		    					console.log("current_page_doing : " + data.jsonData);
