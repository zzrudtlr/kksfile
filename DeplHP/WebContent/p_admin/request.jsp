...
<!--  <div class="loader"> </div> -->
				...
				<div class="row" style="text-align:center; margin:auto;">
                    <div class="col-lg-12">
                      <!--    <h2>시세관리</h2>-->
                        ...
                        <div class="table-responsive" style=" width:1000px; height:500px; text-align:center; margin:auto;">
                            <table class="table table-hover" style="text-align:center; margin:auto;">
                                <thead>
                                    <tr>
										...
										<th class="t_mail">메일</th>
										<th class="t_reg">등록날짜</th>
										
                                    </tr>
                                </thead>
                                <tbody style="width:1000px;" overflow-y="auto" id="board_data">
							...
							<div class="board_page" id = "under_board">
	...
	<script src="../js/admin/request_board.js"></script>
</body>
