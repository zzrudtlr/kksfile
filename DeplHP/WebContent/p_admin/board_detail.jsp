...
<!--  <div class="loader"> </div> -->
				...
				<div class="row" style="text-align:center; margin:auto;">
                    ...
                    <div class="col-lg-12">
                      <!--    <h2>시세관리</h2>-->
                        ...
                        <div class="table-responsive" style=" width:80%; height:800px; text-align:left;">
                          	<table style="float:left; text-align:left;">
									<tbody style="width:700px; ">
										<tr style="text-align:center; ">
											<td style="width:100px;">이름</td>
											<td id="b_name" style="width:400px;"></td>
										</tr>
										<tr style="text-align:center; ">
											<td style="width:100px;">제목</td>
											<td id="b_title" style="width:400px;"></td>
										</tr>
										<tr>
											<td style="width:100px;">이메일</td>
											<td id="b_email" style="width:400px;"></td>
										</tr>
										<tr style="text-align:top;">
											<td style="width:100px;"><p style="height:500px; margin-top:10px;">내용</p></td>
											<td style="width:600px;"><p id="b_message" style="height:500px; margin-top:10px;"></p></td>
										</tr>
										<tr style="text-align:top;">
											<td style="width:100px;">등록날짜</td>
											<td id="b_reg" style="width:400px;"></td>
										</tr>
									</tbody>
								</table>
	...
	<script>
		...
		var xhr = new XMLHttpRequest();
		  xhr.open("POST", "../process/request/get_message_detail.jsp", true);
		  ...
		  xhr.onreadystatechange = function() {//Call a function when the state changes.
		      if(xhr.readyState == XMLHttpRequest.DONE && xhr.status == 200) {
		    	 ...
		    	 document.getElementById("b_title").innerHTML = obj_data.title;
		    	 document.getElementById("b_name").innerHTML = obj_data.name;
		    	 document.getElementById("b_email").innerHTML = obj_data.email;
		    	 document.getElementById("b_message").innerHTML = obj_data.message;
		    	 document.getElementById("b_reg").innerHTML = obj_data.regdate;
		      } 
		  }
		  xhr.send("id="+id);
	</script>
