        ...
        <div class="main-content">
            <div class="fluid-container">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row projects-holder" id="proto_projects">
                    ...
                    <div class="row">
                        <form name="sendRequest" action="#" method="post" class="contact-form">
                            ...
                            <fieldset class="col-md-12 col-sm-12">
                                <input type="button" class="button big default" value="Send Message" onClick="send_form.send_request_data();">
                            </fieldset>
                        </form>
                    </div> <!-- .contact-form -->
                    </div>
         ...
         <!--   <div style="position:absolute; width:100%; height:100%; opacity:0.5; background-color:#ffffff;">
