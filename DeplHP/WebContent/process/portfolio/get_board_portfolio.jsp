...
<%
	...
	try{
		...
		ps = (PreparedStatement)conn.prepareStatement(dinfo.getPortfolio_SQL(l_to, l_count));    
		...
		if(!rs.isBeforeFirst()){
			...
			while(rs.next()){                                                        // 결과를 한 행씩 돌아가면서 가져온다.
				...
				System.out.println("idx : " + rs.getString("idx") + " name : " + rs.getString("name") + " img : " + rs.getString("img") + " contents : " + rs.getString("contents")+ " regdate : " + rs.getString("regdate"));
